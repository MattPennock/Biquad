...
status_t peakingEQ(biquad_t *filter, float center_freq, float Q, float A)
{
...
status_t lowshelf(biquad_t *filter, float center_freq, float Q, float A)
{
...
status_t highshelf(biquad_t *filter, float center_freq, float Q, float A)
{
